...
if want_test_transfer && want_nonswept
  ...
  for didx = 1:datacount
    ...
    if want_test_ft
      ...
      if want_parallel
        [ telist1_raw telist2_raw ] = cEn_calcPartialTEFT_MT( ...
          thisdata, src1idx, src2idx, dstidx, te_laglist, histbins );

        [ telist1_ext telist2_ext ] = cEn_calcPartialTEFT_MT( ...
          thisdata, src1idx, src2idx, dstidx, te_laglist, histbins, struct() );
      else
        [ telist1_raw telist2_raw ] = cEn_calcPartialTEFT( ...
          thisdata, src1idx, src2idx, dstidx, te_laglist, histbins );

        [ telist1_ext telist2_ext ] = cEn_calcPartialTEFT( ...
          thisdata, src1idx, src2idx, dstidx, te_laglist, histbins, struct() );
      end
    else
      ...
      if want_parallel
        [ telist1_raw telist2_raw ] = cEn_calcPartialTE_MT( ...
          src1series, src2series, dstseries, te_laglist, histbins );

        [ telist1_ext telist2_ext ] = cEn_calcPartialTE_MT( ...
          src1series, src2series, dstseries, te_laglist, histbins, struct() );
      else
        [ telist1_raw telist2_raw ] = cEn_calcPartialTE( ...
          src1series, src2series, dstseries, te_laglist, histbins );

        [ telist1_ext telist2_ext ] = cEn_calcPartialTE( ...
          src1series, src2series, dstseries, te_laglist, histbins, struct() );
      end
    end
